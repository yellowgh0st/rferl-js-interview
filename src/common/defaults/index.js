...
defaults.layout.container.xl.width = '1536px'
defaults.layout.container.lg = {}
defaults.layout.container.lg.width = '1200px'
defaults.layout.container.md = {}
defaults.layout.container.md.width = '900px'
defaults.layout.container.md.padding = '3rem 1.25rem 6.2rem'
defaults.layout.container.sm = {}
defaults.layout.container.sm.width = '600px'
